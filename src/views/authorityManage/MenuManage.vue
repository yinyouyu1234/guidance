    ...
    <search>
      <el-form :inline="true">
        ...
        <el-form-item label="菜单名称">
          <el-input size="mini" v-model="condition.menu_name" clearable placeholder="请输入菜单名称"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button @click="filter" type="primary" size="mini">搜索</el-button>
    ...
    >
      ...
      >
        ...
        <el-form-item label="图标">
          <el-input
            size="mini"
            v-if="condition.application_code == 'SHAANGU_WEB'"
            placeholder="请输入图标名称"
            v-model="ruleForm.icon"
          ></el-input>
          <el-upload
            v-if="dialogFormVisible && condition.application_code == 'SHAANGU_APP'"
            :action="url"
  ...
  methods: {
    ...
    submit(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (this.condition.application_code == "SHAANGU_APP") {
